 ...
 */
$proradio_section = $proradio_stickycolumn = $el_class = $el_id = $width = $parallax_speed_bg = $parallax_speed_video = $parallax = $parallax_image = $video_bg = $video_bg_url = $video_bg_parallax = $css = $offset = $css_animation = '';
$output = '';
...
// customization
if($proradio_stickycolumn){
	$css_classes[] = 'proradio-stickycol';
}
...
$wpb_wrapper_class = '';
if($proradio_section){
	$wpb_wrapper_class  = 'proradio-vc_section';
}
