		...
		<div class="proradio-section">
			<div class="proradio-container">
				<div class="proradio-row proradio-stickycont">
					<div id="proradio-loop" class="proradio-col proradio-s12 proradio-m12 proradio-l8 <?php if( !is_active_sidebar( 'proradio-right-sidebar' ) ){ ?> proradio-offset-l2 <?php } ?>">
						<?php 
						/**
					...
					<?php  
					if( is_active_sidebar( 'proradio-right-sidebar' ) ){
					?>
