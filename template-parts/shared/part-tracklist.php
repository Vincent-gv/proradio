...
if(function_exists('qtmplayer_tracklist')) {
	$atts = array(
		'id' => $post->ID,
		'title_classes'	=> 'proradio-caption proradio-caption__s',
		'classes' => 'proradio-tracklist-container', // additional container classes
		'print' => true // include the echo function
	);
	if( get_theme_mod( 'proradio_replace_default', '1' ) == '0') {
